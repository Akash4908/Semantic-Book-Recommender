...
data_file = os.path.join(base_dir, "Books_cleaned.xls")

if not os.path.exists(data_file):
    raise FileNotFoundError(f"❌ {data_file} not found. Please ensure Books_cleaned.xls is in the project directory.")
