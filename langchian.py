...
file_path = os.path.join(base_dir, "Books_cleaned.xls")

if not os.path.exists(file_path):
    raise FileNotFoundError(f"❌ {file_path} not found. Please ensure Books_cleaned.xls is in the project directory.")
